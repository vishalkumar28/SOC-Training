    ...
    <div className="min-h-full">
      ...
      <section id="course-overview" className="mx-auto max-w-7xl border-t border-border px-4 py-12 sm:px-8 sm:py-16">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <TrackCard day="CAPSTONE" title="Final Investigation" description="Apply the full workflow in the Operation Shadow Trace final investigation." href="/course/day2/operation-shadow-trace-final-investigation" icon={<ShieldAlert className="h-5 w-5" />} tone="warning" />
        </div>
      </section>
