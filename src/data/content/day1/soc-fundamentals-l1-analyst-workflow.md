...
text
                    ...
                    └──────┬──────┘
                           ↓
                    ┌─────────────┐
                    │ VALIDATION  │  ← Is this a real security event?
                    └──────┬──────┘
                           ↓
                    ┌─────────────┐
                    │   TRIAGE    │  ← What is the severity? What is the priority?
                    └──────┬──────┘
                           ↓
                    ┌─────────────┐
                    │   CONTEXT   │  ← Gather additional information
                    │  GATHERING  │
                    └──────┬──────┘
                           ↓
                    ┌─────────────┐
                    │INVESTIGATION│  ← Dig deeper into the event
                    └──────┬──────┘
                           ↓
                    ┌─────────────┐
                    │  SEVERITY   │  ← Assign final severity
                    │ ASSESSMENT  │
                    └──────┬──────┘
                           ↓
                    ┌─────────────┐
